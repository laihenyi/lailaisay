...
impl WindowDelegate {
    ...
    pub fn set_blur(&self, blur: bool) {
        // lailaisay: window background blur used the private
        // CGSSetWindowBackgroundBlurRadius API, which the Mac App Store rejects.
        // Blur is not supported in this build; the request is ignored.
        let _ = blur;
    }
